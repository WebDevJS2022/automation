...
from pages.elemets_page import TextBoxPage, CheckBoxPage, RadioButtonPage, WebTablePage, ButtonsPage, LinksPage, \
...
class TestElements:
    ...
    class TestLinksPage:
        ...
        def test_check_link(self, driver):
            ...
            links_page.open()
            href_link, current_url = links_page.check_new_tab_simple_link(driver)
    ...
    class TestDynamicProperties:
        ...
        def test_dynamic_properties(self, driver):
            ...
            assert color_after != color_before, "the color of button not been changed"

        def test_appear_button(self, driver):
            dynamic_properties_page = DynamicPropertiesPage(driver, 'https://demoqa.com/dynamic-properties')
            dynamic_properties_page.open()
            appear = dynamic_properties_page.check_appear_of_button()
            assert appear is True, "the button not appear"
